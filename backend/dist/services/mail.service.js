...
class MailService {
    ...
    constructor() {
        this.transporter = nodemailer_1.default.createTransport({
            host: mail_config_1.config.mail.host,
            port: mail_config_1.config.mail.port,
            secure: mail_config_1.config.mail.secure,
            auth: mail_config_1.config.mail.auth,
        });
    }
    ...
    `;
        await this.transporter.sendMail({
            from: mail_config_1.config.mail.from,
            to: mail_config_1.config.mail.to,
