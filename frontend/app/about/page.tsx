            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-8 bg-[#0F1419] p-8 border border-[#374151] rounded-sm group hover:border-[#B68817] transition-colors">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div>
                    <a href="https://share.google/9XGQNnzhdZ1kKi11e" className="inline-flex items-center px-4 py-2 border border-[#B68817] text-[#B68817] rounded-sm text-sm font-medium hover:bg-[#B68817] hover:text-white transition-colors">
                      Buy Book
              ...
              <div className="flex flex-col sm:flex-row gap-8 bg-[#0F1419] p-8 border border-[#374151] rounded-sm group hover:border-[#B68817] transition-colors">
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div>
                    <a href="https://share.google/yPrThoWmQ0bXVvcLC" className="inline-flex items-center px-4 py-2 border border-[#B68817] text-[#B68817] rounded-sm text-sm font-medium hover:bg-[#B68817] hover:text-white transition-colors">
                      Buy Book
                      <svg className="w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                      </svg>
